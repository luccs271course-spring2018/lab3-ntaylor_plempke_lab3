...
public class TestList {
    ...
    public void setUp() throws Exception {
        ...
        // TODO FINISHED also try with a LinkedList - does it make any difference?
    }
    ...
    public void testSizeNonEmpty() {
        // TODO FINISHED fix the expected values in the assertions below
        list.add(77);
    ...
    public void testContains() {
        // TODO FINISHED write assertions using
        // list.contains(77)
    ...
    public void testRemoveObject() {
        ...
        list.add(77);
        list.add(6);
        list.remove(5); // what does this method do? Removes the item at index 5 which also happens to be the final value 77
        // TODO FINISHED fix the expected values in the assertions below
        ...
        assertEquals(77, list.get(3).intValue());
        list.remove(Integer.valueOf(5)); // what does this one do? Removes the item at index 4, which is the number 5
    ...
    public void testContainsAll() {
        ...
        list.add(77);
        list.add(66);
        // TODO FINISHED using containsAll and Arrays.asList (see above),
    ...
    public void testAddAll() {
        // TODO FINISHED in a single statement using addAll and Arrays.asList,
    ...
    public void testRemoveAll() {
        ...
        list.add(77);
        list.add(66);
        // TODO FINISHED in a single statement using removeAll and Arrays.asList,
    ...
    public void testRetainAll() {
        ...
        list.add(77);
        list.add(66);
        // TODO FINISHED in a single statement using retainAll and Arrays.asList,
        // remove items from the list to make the following assertions pass
        // (without touching the assertions themselves)
    ...
    public void testSet() {
        ...
        list.add(77);
        list.add(66);
        // TODO FINISHED use the set method to change specific elements in the list
    ...
    public void testSubList() {
        ...
        list.add(77);
        list.add(66);
        // TODO ASK WHY NOT 2,4  OR 1,5 ??????  fix the arguments in the subList method so that the assertion
        // passes
